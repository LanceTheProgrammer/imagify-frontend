  ...
  return (
    ...
    <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>Easily bring your ieas to life with our free Ai image generator. Whether you need stunning visuals ore unique imagerty, our tool transforms your text into eye-catching image with just a few clicks. Imagine it, describe it, and watch it come to life instantly. </p>
